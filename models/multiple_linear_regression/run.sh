...
cp $1 input
docker build -t coffeebreak/multiple_linear_regression --build-arg data=input .
rm input
docker run -it --name coffebreak_multiple_linear_regression coffeebreak/multiple_linear_regression
